package com.example.pear.bt_data_stream;
            ...
            public void handleMessage(android.os.Message msg) {
                if (msg.what == handlerState) {                                     //if message is what we want
                    ...
                    if (endOfLineIndex > 0) {                                           // make sure there data before ~
                        ...
                        {
                            String stevilo_obratov, hitrost;
                            String[] parts = dataInPrint.split("-");

                            stevilo_obratov = parts[0].substring(1);
                            hitrost = parts[1];

                            sensorView0.setText( stevilo_obratov );    //update the textviews with sensor values
                            sensorView1.setText( hitrost );    //update the textviews with sensor values
                        ...
                        //preveri ali pravilno nastavili dolzino
                            ...
                            if (prejeto.equals(Integer.toString(stevka_dolzina))) {
                                txtStringLength.setText("send-received: ok");
//                                Toast.makeText(getBaseContext(), "OK", Toast.LENGTH_SHORT).show();
                                btnOff.setBackgroundColor(0xFF00FF00);
                            }
...
//                mConnectedThread.write("R!");    // Send "1" via Bluetooth
                mConnectedThread.write("$!");    // Send str via Bluetooth
                Toast.makeText(getBaseContext(), "osvezujem", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onResume() {
        ...
        address = intent.getStringExtra(Prvi_zaslon.EXTRA_DEVICE_ADDRESS);
        ...
        //ce je tole notri, vsake toliko časa posljmo "x" znak; kar ni OK
